...
export default function RejectedApplication() {
  ...
  const fetchNewLoans = () => {
    axios
      ...
      .then((res) => {
        const filteredArray = res.data.filter((ele:any)=> ele.rejected === true && ele.approved === false)
  ...
  // const filteredArray = props.newLoans.filter((ele)=> ele.rejected === true && ele.approved === false)
