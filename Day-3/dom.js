...
for (i in arr.results){
    ...
    let name =arr.results[i].name.first + " " + arr.results[i].name.last
    console.log(name)
let email = arr.results[i].email
let phone = arr.results[i].phone
let address = arr.results[i].location.city + " " + arr.results[i].location.postcode
let image = arr.results[i].picture.large

console.log(phone,address)

let trNode =  document.createElement('tr') 

let tdNode1 =  document.createElement('img') 
tdNode1.setAttribute('src', image)

let tdNode2 =  document.createElement('td') 
tdNode2.innerHTML = name

let tdNode3 =  document.createElement('td') 
tdNode3.innerHTML = email

let tdNode4 =  document.createElement('td') 
tdNode4.innerHTML = phone

let tdNode5 =  document.createElement('td') 
tdNode5.innerHTML = address
